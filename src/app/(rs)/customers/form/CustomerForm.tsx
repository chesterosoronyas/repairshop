                ...
                <form onSubmit={form.handleSubmit(submitForm)} className='flex flex-col md:flex-row gap-4 md:gap-8'>
                    <div className='flex flex-col gap-4 w-full max-w-xs'>
                                <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="First Name" nameInSchema='firstName'/>
                                 <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="Last Name" nameInSchema='lastName'/>
                                 <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="Address 1" nameInSchema='address1'/>
                            <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="Address 2" nameInSchema='address2'/>
                                     <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="City" nameInSchema='city'/>
                            <SelectWithLabel<insertCustomerSchemaType> fieldTitle="State" nameInSchema='state' data={StatesArray}/>

                    </div>
                    <div className='flex flex-col gap-4 w-full max-w-xs'>
                    <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="Zip Code" nameInSchema='zip'/>
                                    
                     <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="Email" nameInSchema='email'/>
                     <InputWithLabel<insertCustomerSchemaType>
                                    fieldTitle="Phone" nameInSchema='phone'/>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <Button type='submit'  variant={'destructive'} title='Reset' onClick={()=>form.reset(defaultValues)}>
                            Reset
                        </Button>
                    </div>
